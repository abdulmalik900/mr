...
const ServicesPageCard = () => {
  return (
    ...
    <div className="grid lg:grid-cols-3  mb-5  px-10 md:grid-cols-2 gap-7 grid-cols-1">

            {/* Card 1 */}
            <div className='flex items-center justify-center bg-white mx-auto w-full h-[320px] border border-t-8 border-r-8 border-b-8 border-b-[#5294C7] rounded-lg border-r-[#5294C7] border-t-[#5294C7] pt-4'>
  <div className='text-center'>
    ...
    <p className='text-gray-600 px-6 text-justify font-kamerik pb-10 font-normal text-base leading-relaxed'>
      We offer a diverse fleet of well-maintained trucks, from compact pickups to spacious cargo vans, to perfectly match your hauling needs.
    </p>
  </div>
</div>
 ...
 {/* Card 2 */}
 <div className='bg-white mx-auto  w-full h-[320px] border border-t-8 border-r-8 border-b-8 border-b-[#5294C7] rounded-lg border-r-[#5294C7] border-t-[#5294C7]  pt-4 '>
    <div className=''>
            <Image
  ...
  <div className='text-center'>
    ...
    <p className='text-gray-600 px-6 text-justify font-kamerik pb-10 font-normal text-base leading-relaxed'>
      We offer a diverse fleet of well-maintained trucks, from compact pickups to spacious cargo vans, to perfectly match your hauling needs.
            ...
            {/* Card 4 */}
    <div className='bg-white w-full h-[320px] border border-t-8 border-r-8 border-b-8 border-b-[#5294C7] rounded-lg border-r-[#5294C7] border-t-[#5294C7]  pt-4 '>
    <div className=''>
            <Image
