    ...
    <>
      ...
      <div className="grid w-full lg:grid-cols-3 gap-8 md:grid-cols-2 grid-cols-1 md:px-10 lg:px-12 px-6 pb-5 bg-gray-200 ">
        ...
        <div className=" pt-2 border-2  rounded-lg border-[#5294C7]  w-[476] h-[484]">
          ...
          <div className="bg-[#5294C7] text-center items-start  rounded-lg   border-r-1 px-5   w-[500] py-10 h-[300] mt-3 flex-shrink-0">
            ...
            <p className="text-white font-sans text-base pt-3 leading-9">
        ...
        <div className=" pt-2 border-2  rounded-lg border-[#5294C7]   w-[476] h-[484]">
          ...
          <div className="bg-[#5294C7] text-center items-start  rounded-lg    border-r-1 px-5  w-[500]   py-10 h-[300] mt-3 flex-shrink-0">
            ...
            <p className="text-white font-sans text-base pt-3 leading-">
              The Fuso Canter Box 5 Ton is a medium-duty truck with a cargo box
              and a 5-ton payload capacity.
            </p>
          </div>
        </div>
        ...
        <div className=" pt-2 border-2  rounded-lg border-[#5294C7]  w-[476] h-[484]">
          ...
          <div className="bg-[#5294C7] text-center items-start  rounded-lg  px-5  border-r-1   w-[500] py-10 h-[300] mt-3 flex-shrink-0">
            <h1 className="flex flex-col text-white font-bold pt-1  items-center w-443 h-78 flex-shrink-0">
              Mitsubishi Fuso Canter Box 10 Ton
            </h1>
            <p className="text-white font-sans text-base pt-3 leading-9">
              The Mitsubishi Fuso Canter Box 10 Ton is a heavier-duty version
        ...
        <div className=" pt-2 border-2  rounded-lg border-[#5294C7]  w-[476] h-[484]">
          ...
          <div className="bg-[#5294C7] text-center items-start  px-5 rounded-lg   border-r-1   w-[500] py-10 h-[300] mt-3 flex-shrink-0">
            <h1 className="flex flex-col text-white font-bold pt-1  items-center w-443 h-78 flex-shrink-0">
              Mitsubishi Fuso Open Top 3 Ton
            </h1>
            <p className="text-white font-sans text-base pt-3 leading-9">
              Open Top 3 Ton is a medium-duty truck with an open bed and a 3-ton
              payload capacity.
            </p>
          </div>
        </div>
        ...
        <div className=" pt-2 border-2  rounded-lg border-[#5294C7]  w-[476] h-[484]">
          ...
          <div className="bg-[#5294C7] text-center items-start  rounded-lg  px-5 border-r-1   w-[500] py-10 h-[300] mt-3 flex-shrink-0">
            ...
            <p className="text-white font-sans text-base pt-3 leading-9">
              The top-of-the-line refrigeration systems to keep your goods fresh
              and cool.
            </p>
          </div>
        </div>
        ...
        <div className=" pt-2 border-2  rounded-lg border-[#5294C7]  w-[476] h-[484]">
          ...
          <div className="bg-[#5294C7] text-center items-start  rounded-lg px-5  border-r-1   w-[500] py-10 h-[300] mt-3 flex-shrink-0">
            ...
            <p className="text-white font-sans text-base pt-3 leading-6">
              This versatile truck is well-suited for a furniture removal for
              houses, villas and office shifting 
            </p>
          </div>
        </div>
      </div>
